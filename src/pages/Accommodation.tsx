...
import tiger from '@/lib/downloadc.jpeg'
import polon from '@/lib/Tip voor een bezoek aan Polonnaruwa.jpeg'
...
const Accommodation: React.FC = () => {
  ...
  const accommodations: RoomType[] = [{
    id: "Safari Tour at Yala National Park",
    title: "Safari Tour at Yala National Park",
    description: "Yala Safari Tour will take you on a thrilling wildlife adventure in Sri Lanka!Are you an adventurous person who loves to travel? or are you a person who admires nature? Yala Safari Tour will fulfill all of these requirements.This Yala Safari Tour is particularly designed to provide the best safari experience to our clients. You will be accompanied by our well-knowledgeable guides who are proficient in English. If you require language-specific guides, that can be arranged upon request. You will get an unforgettable experience in the wilderness while breathing in the freshest air from the forest around.",
    price: 300,
    capacity: 2,
    size: "600 sq ft",
    bedType: "1 King",
    ...
    id: "Day Tour at Polonnaruwa Ancient City",
    title: "Day Tour at Polonnaruwa Ancient City",
    description: "Step into Sri Lanka’s rich past with our Polonnaruwa Day Tour, an unforgettable journey through one of the island’s most remarkable ancient cities. As part of the cultural triangle and a UNESCO World Heritage Site, Polonnaruwa offers an incredible blend of history, culture, and architecture. From magnificent ruins of royal palaces to the iconic Gal Viharaya Buddha statues, this tour is designed to give you a deep insight into the grandeur of Sri Lanka’s ancient kingdoms. Perfect for history lovers, culture seekers, and curious travelers, our expert guides will ensure you experience the very best of this historic royal city in a single day.",
    price: 250,
    capacity: 2,
    size: "550 sq ft",
    bedType: "1 King",
