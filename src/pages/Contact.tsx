                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <a href="tel:+918904704234" className="text-blue-700 hover:underline">
                          +91 8904704234
                        </a>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <a href="mailto:dandeliadventures.in@gmail.com" className="text-blue-700 hover:underline">
              ...
              <div className="lg:col-span-2">
                <div className="bg-white p-6 rounded-lg shadow-md">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          name="name"
                          required
                          className="w-full p-3 border border-input rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition"
                        />
                      </div>
                    ...
                    <Button
                      type="submit"
                      className="w-full sm:w-auto bg-blue-700 hover:bg-blue-800 text-white flex items-center justify-center gap-2"
                    >
                      <Send size={16} />
                      Send Message
                    </Button>
